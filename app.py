...
# Configuration
UPLOAD_FOLDER = '/tmp/uploads'  # Use /tmp for Render (writable)
ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'gif', 'bmp', 'tiff'}
MODEL_PATH = 'waste_classifier.keras'
CLASS_MAPPING_PATH = 'class_mapping.json'
IMG_SIZE = (224, 224)
...
print("\n" + "="*70)
print("🚀 WASTE CLASSIFIER API - INITIALIZATION (RENDER)")
print("="*70)
...
try:
    ...
    print(f"⚠️  Using default class mapping")
    class_mapping = {
        "0": "cardboard",
        "1": "compost",
        "2": "glass",
